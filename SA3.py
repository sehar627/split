...
def update_dashboard():
    ...
    add_members()
# Update the dashboard when the app starts
...
def build_add_expense_screen():
    ...
    def on_back_btn_press(instance):
        add_expense(instance)
        go_to_dashboard(instance)

    back_btn.bind(on_press=on_back_btn_press)
